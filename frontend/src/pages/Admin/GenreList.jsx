...
<div className="flex flex-wrap">
  ...
  {genres?.map((genre) => (
    ...
    <div key={genre._id}>
      ...
      <button className="bg-white border border-tea-500 text-teal-500 py-2 px-4 rounded-lg m-3 hover:bg-teal-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50" onClick={() => {
